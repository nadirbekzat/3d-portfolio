...
let projects = [
  {
    image: 'textures/project-luqapay.png',
    url: 'https://luqapay.com/',
  },
  {
    image: 'textures/project-mancity.png',
    url: 'https://www.mancity.com/',
  },
  {
    image: 'textures/project-asu.png',
    url: 'https://asuonline.asu.edu/about-us/why-asu-online/?utm_source=gdn&utm_medium=PMX&utm_content=Conversion_Attribute-Brand-Proceedtorfi&utm_campaign=22-Core_Acq-Hi_PMX_Nat_IVT&utm_ecd22=22&gclid=CjwKCAiAtt2tBhBDEiwALZuhAA5lzMEBYhUphlc3lPdLyBXXQ-WE_mnvpccYJI1KZDo6wHUBU24EWxoCqfgQAvD_BwE&gclsrc=aw.ds',
  },
  {
    image: 'textures/project-ohm.png',
    url: 'https://ohmp2p.com/',
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const titleGeo = new TextGeometry('BEKZAT NADIR', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
